...
Directional guidance from this benchmark (static images only). Not a hard rule — useful context when picking a model. A light blind style-tag pass ([style fingerprint](pixellab-image-model-style-fingerprint.md)) independently validates these profiles.
