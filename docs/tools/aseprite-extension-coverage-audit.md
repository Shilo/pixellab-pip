...
| Multi-image edit | In-editor edit using multiple supplied images; observed operation name `generate-multi-edit`. | MCP `edit_image` (`images_base64` list of 1-16, or reference mode) when MCP-first; REST v2 `edit-images-v2` for exact schema control; website/editor for visual experimental flows. |
