...
| Local artifact organization | Defines named areas for payloads, results, candidates, approvals, downloads, reports, and logs. | Does not prescribe stable project artifact directories; reports returned paths/URLs when relevant. |
