...
- [PixelLab 16:9 Indoor Background Duplication Research Spike](pixellab/pixellab-16x9-indoor-duplication-research-spike.md) - two controlled 20-call Pixen studies that identify a reliable 640x360 prompt pattern: continuous side walls, one far wall, and one small centerline console.
