...
- [PixelLab Image-to-Text Research Spike](pixellab/pixellab-image-to-text-research-spike.md) - the image-to-text REST contract, its overlap with target-specific prompt enhancers, route-selection guidance, MCP gap, and cost caveats.
...
- [PixelLab PixMiniMax vs v3 Animation Spike](pixellab/pixellab-pixminimax-vs-v3-animation-spike.md) - public PixMiniMax/MiniMax H3 contract research, H3 prompt adaptation, website/Aseprite findings, and the paired live v3 comparison, including its seed-control limitation.
