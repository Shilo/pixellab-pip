...
- [PixelLab 16:9 Indoor Background Duplication Research Spike](pixellab/pixellab-16x9-indoor-duplication-research-spike.md) - four controlled 20-call Pixen studies plus Pro centering and full-bleed follow-ups showing a concise Pro prompt can meet centering, no-duplication, and (in a 2-call check) edge-to-edge requirements at 640x360.
