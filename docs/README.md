...
- [PixelLab 16:9 Indoor Background Duplication Research Spike](pixellab/pixellab-16x9-indoor-duplication-research-spike.md) - four controlled 20-call Pixen studies plus Pro centering, full-bleed, and cross-domain prompt follow-ups showing concise Pro prompts can meet centering, no-duplication, and edge-to-edge requirements at 640x360.
