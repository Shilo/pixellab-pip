...
- [PixelLab 16:9 Indoor Background Duplication Research Spike](pixellab/pixellab-16x9-indoor-duplication-research-spike.md) - four controlled 20-call Pixen studies plus a 10-call Pro study showing prompt-only Pro can meet centering and no-duplication requirements at 640x360, while Pixen exact-centering remains unresolved.
