...
| Create S-XL image (Pro) | `POST /v2/generate-image-v2` | Pro image generation | Multiple candidates, reference images, style image, and the better observed route for a static south-facing candidate; costs more and produces a different, broader character style than Pixen | up to `256x256 $0.095`; up to `341x341 $0.125`; up to `512x512 $0.185` |
