...
- Image operations: `/image-to-pixelart`, `/image-to-pixelart-pro`, `/resize`, `/remove-background`, `/edit-image`, `/edit-image-pixen`, `/edit-images-v2`, `/inpaint`, `/inpaint-v3`, `/edit-image-pro-flash`, `/inpaint-image-pro-flash`.
...
- Raw image (no managed asset): `create_image_pixflux`, `create_image_pixen`, `create_image_pro`, `create_image_pro_flash`, `get_image`, `edit_image`, `edit_image_pixen`, `edit_image_pro_flash`, `inpaint_image`, `inpaint_image_pro_flash`, `animate_image`, `animate_image_pixminimax`, `image_to_pixelart`, `unzoom_image`, `correct_pixelart`, `reduce_colors`; Pro Flash size lookup: `get_pro_flash_capabilities`.
