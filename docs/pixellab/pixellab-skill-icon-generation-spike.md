...
Inventory item, equipment, loot, pickup, or transparent RPG item-icon requests route through `skills/pixellab-pip/references/icon.md`.
...
- `item icon`, `inventory icon`, `equipment icon`, `loot icon`, `pickup icon`, or transparent RPG item sheet: inventory icon art, read `references/icon.md` and prefer REST `generate-image-v2`.
