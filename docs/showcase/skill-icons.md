...
[
  ...
  },
  {
    "TASK": {
      ...
      "outputs": ["fantasy-rpg-skill-64px-4x4.png"],
      "verify": "The sheet is exactly 256x256 with sixteen 64x64 cells, and every cell is pixel-identical to its corresponding returned image."
    }
  }
]
```
