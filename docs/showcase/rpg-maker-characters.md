...
The standing column reuses the reviewed static rotation. The two movement columns use walk frames 02 and 04 — the chronologically ordered pair of distinct opposing strides — verified per direction in every run rather than assumed. The two frames of each pair differ by 598 to 753 pixels in MZ, 529 to 587 in MV, and 250 to 281 in the smaller VX Ace sprite, and in all twelve pairs the foot centroid crosses to the opposite side between the frames. Neither movement column is a duplicate of the other or a near-repeat of standing.
