...
[
  ...
  {
    "_comment": "Animates the character created in step 1: pass its character_id (runtime value from create_character, omitted here). Follow-up request: 'it should be happy and also loopable, ... must be a repeated smile or tongue out'.",
