...
Refactor rules:
- Preserve functionality, correctness, safety, and efficiency above blind minimalism. Use KISS to simplify and YAGNI to remove what is not needed. Shorter is not automatically better — challenge every cut and every addition.
