...
| Skill icon, ability icon, spell icon, action-bar icon, or hotbar icon | Read `references/skill-icons.md` before choosing an endpoint or generating. | Use the reference for REST v2 route choice, background handling, sheet sizing, prompt wording, anti-patterns, and verification. |
