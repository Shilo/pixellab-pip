...
- `--renderer claude`: call `claude -p` in safe, no-tools mode with a JSON schema to convert descriptions into a constrained semantic render recipe, then render locally.
