...
| Any language | Work with Pip in any language and it answers in yours. PixelLab works in English, so Pip translates your request into the English it sends — and shows you that English next to your own words so you can check it. |
